...
const { useLocalizer, useRenderMarkdownAsHTML, useStyleSet } = hooks;
...
const MarkdownTextContent = memo(({ entities, markdown }: Props) => {
  ...
  const handleCitationClick = useCallback<Exclude<PropsOf<typeof LinkDefinitions>['onCitationClick'], undefined>>(
    url => {
